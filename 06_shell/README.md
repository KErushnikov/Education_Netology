...
- второй - прибавляет к параметру единицу как число.
  ...
  **6**
## Ответ:
https://github.com/KErushnikov/Education_Netology/blob/main/06_shell/test_1.ps1
https://github.com/KErushnikov/Education_Netology/blob/main/06_shell/test_2.ps1
...
**Total: 22**  
## Ответ:
https://github.com/KErushnikov/Education_Netology/blob/main/06_shell/test_dir.ps1
...
## Ответ:
https://github.com/KErushnikov/Education_Netology/blob/main/06_shell/test.ps1
...
```
## Ответ:
https://github.com/KErushnikov/Education_Netology/blob/main/06_shell/script.ps1